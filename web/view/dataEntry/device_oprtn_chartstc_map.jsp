...
<div class="container" style="margin-top: 5%">
    <table class="table table-hover"  style="background-color:#d0dafd ">
                ...
                <tr>
                    <td align="center" class="header_table" width="100%">Device Operation Characteristics Map</td>
...
<!--                                                <td>Rule<input class="input" type="text" id="searchRule" name="searchRule" value="${searchRule}" size="20" ></td>-->
                                                <td>Manufacturer Name</td><td><input class="form-control" type="text" id="searchCommandName" name="searchCommandName" value="${searchCommandName}" size="20" ></td>
                                                ...
                                                <td>Model</td><td><input class="form-control" type="text" id="searchModelName" name="searchModelName" value="${searchModelName}" size="20" ></td>                                               
...
<!--                                                <td><input type="button" class="pdf_button" id="viewPdf" name="viewPdf" value="" onclick="displayMapList()"></td>-->
                ...
                <table class="table table-hover" border="1" style="border-color:#d0dafd">
                                            <tr>
                                                ...
                                                <th>Model</th>
                                                <th>Service Name</th>
                                                <th>Characteristic Read</th>
                                                <th>Characteristic Write</th>
                                                <th>Ble Operation Name</th>
                                                <th>Order No</th>
                                                <th>Remark</th>
                                            </tr>
        ...
        <div class="container">
                                    ...
                                    <table class="table table-hover" border="1" style="border-color:#d0dafd">
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="form-control"  type="text" id="manufacturer" name="manufacturer" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Device Type</th>
                                                <td><input class="form-control" type="text" id="device_type" name="device_type" value="" size="40" disabled>
                                                <input class="form-control"  type="hidden" id="device_characteristic_ble_map_id" name="device_characteristic_ble_map_id" value="" ></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Model</th>
                                                <td><input class="form-control" type="text" id="model" name="model" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Services</th>
                                                <td><input class="form-control" type="text" id="service_name" name="service_name" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Read Characteristics</th>
                                                <td><input class="form-control" type="text" id="read_characteristics" name="read_characteristics" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1"> Write Characteristics</th>
                                                <td><input class="form-control" type="text" id="write_characteristics" name="write_characteristics" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">BLE Operation name</th>
                                                <td><input class="form-control" type="text" id="ble_operation_name" name="ble_operation_name" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
