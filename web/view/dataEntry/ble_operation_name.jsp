...
<html>
    ...
    <script type="text/javascript" language="javascript">
              ...
              $(function () {
            $("#searchCommandName").autocomplete({
                source: function (request, response) {
                    debugger
                    $.ajax({
                        url: "BleOperationNameCont.do",
                        type: "GET",
                        dataType: "json",
                        data: {action1: "getCommandName"},
                ...
                select: function (events, ui) {
                    console.log(ui);
                    $('#searchCommandName').val(ui.item.label); // display the selected text
                    return false;
                }
            });
        });
...
//        document.getElementById("revise").disabled =false;
        ...
        <div class="container" style="margin-top: 5%">
            <table class="table table-hover"  style="background-color:#d0dafd ">
                ...
                <tr>
                    <td align="center" class="header_table" width="100%">Ble Operation</td>
...
<!--                                                <td>Rule<input class="input" type="text" id="searchRule" name="searchRule" value="${searchRule}" size="20" ></td>-->
                        <td>Ble Operation Name</td><td><input class="form-control" type="text" id="searchCommandName" name="searchCommandName" value="${searchCommandName}" size="20" ></td>
        ...
        <form name="form2" method="POST" action="BleOperationNameCont.do" onsubmit="return verify()">
            <table class="table table-hover" border="1" style="border-color:#d0dafd">
                ...
                <tr>
                    <th>Ble Operation Name</th>
                    <td><input class="form-control" type="text" id="ble_operation_name" name="ble_operation_name" value="" size="100" disabled></td>
                    <input class="form-control" type="hidden" id="ble_operation_name_id" name="ble_operation_name_id" value="" >
                </tr>                                          
                <tr>
                    <th>Remark</th>
