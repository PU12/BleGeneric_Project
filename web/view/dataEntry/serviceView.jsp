...
<script  type="text/javascript" src="time/bootstrap-datetimepicker.min.js"></script>
      ...
      $(function () {
            $("#manufacturer").autocomplete({
                ...
                select: function (events, ui) {
                    console.log(ui);
                    $('#manufacturer').val(ui.item.label); // display the selected text
                    return false;
                }
            });
        });
            ...
            $("#device_type").autocomplete({
                source: function (request, response) {
                    ...
                    $.ajax({
                        ...
                        type: "GET",
                        dataType: "json",
                        data: {action1: "getDeviceType",action2:$("#manufacturer").val()},
                        success: function (data) {
            ...
            $("#model").autocomplete({
                source: function (request, response) {
                    ...
                    $.ajax({
                        ...
                        type: "GET",
                        dataType: "json",
                        data: {action1: "getModelType",action2:$("#manufacturer").val(),action3:$("#device_type").val()},
                        success: function (data) {
  ...
  $(function () {
            $("#searchServiceName").autocomplete({
                source: function (request, response) {
                    debugger
                    $.ajax({
                        url: "ServiceCont.do",
                        type: "GET",
                        dataType: "json",
                        data: {action1: "getSearchServiceName"},
                        success: function (data) {
                ...
                select: function (events, ui) {
                    console.log(ui);
                    $('#searchServiceName').val(ui.item.label); // display the selected text
                    return false;
                }
            });
        });
                    ...
                    <td align="center" class="header_table" width="100%">Services</td>
                                    ...
                                    <form name="form0" method="POST" action="ServiceCont.do">
                                      <table class="table table-hover" border="1" style="border-color:#d0dafd">
                                            <tr>
                                                <td>Service Name<input class="form-control" type="text" id="searchServiceName" name="searchServiceName" value="${searchDeviceType}" size="20" ></td>
                                    ...
                                    <form name="form2" method="POST" action="ServiceCont.do" onsubmit="return verify()">
                                        <table class="table table-hover" border="1" style="border-color:#d0dafd">
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="form-control" type="text" id="service_name" name="service_name" value="" size="40" disabled>
                                                <input class="form-control" type="hidden" id="service_id" name="service_id" value="" ></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Service UUID</th>
                                                <td><input class="form-control" type="text" id="service_uuid" name="service_uuid" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="form-control" type="text" id="device_type" name="device_type" value="" size="40" disabled></td>
                                            </tr>
