...
<script  type="text/javascript" src="time/bootstrap-datetimepicker.min.js"></script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(function () {
            $("#searchDeviceType").autocomplete({
                source: function (request, response) {
                    debugger
                    $.ajax({
                        url: "DeviceTypeCont.do",
                        type: "GET",
                        dataType: "json",
                ...
                select: function (events, ui) {
                    console.log(ui);
                    $('#searchDeviceType').val(ui.item.label); // display the selected text
                    return false;
                }
            });
        });
                                    ...
                                    <form name="form0" method="POST" action="DeviceTypeCont.do">
                                     <table class="table table-hover" border="1" style="border-color:#d0dafd">
                                            <tr>
                                                ...
                                                <td><input class="btn btn-danger" type="button" name="task" id="nextPage" value="Next Page" onclick="goToManufacturer()"></td>
                                    ...
                                    <form name="form2" method="POST" action="DeviceTypeCont.do" onsubmit="return verify()">
                                         <table class="table table-hover" border="1" style="border-color:#d0dafd">
                                            ...
                                            <tr>
                                                ...
                                                <td><input  class="form-control" type="text" id="device_type" name="device_type" value="${manufacturer}" size="40" disabled>
                                                <input  class="form-control" type="hidden" id="device_type_id" name="device_type_id" value="" ></td>
                                            </tr>
                                            <tr>
