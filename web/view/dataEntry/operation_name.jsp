                                    ...
                                    <form name="form2" method="POST" action="OperationNameCont.do" onsubmit="return verify()">
                                        <table class="table table-hover" border="1" style="border-color:#d0dafd">
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="form-control"  type="text" id="operation_name" name="operation_name" value="" size="40" disabled>
                                                <input class="form-control"  type="hidden" id="operation_name_id" name="operation_name_id" value="" ></td>
                                            </tr>
                                            <tr>
