                    ...
                    <td align="center" class="header_table" width="100%">Device Registration</td>
                                    ...
                                    <form name="form0" method="POST" action="DeviceRegistrationCont.do">
                                        <table class="table table-hover" border="1" style="border-color:#d0dafd">
                                            <tr>
                                                <td>Manufacture Name</td><td><input class="form-control" type="text" id="searchManufactureName" name="searchManufactureName" value="${searchManufacturerName}" size="20" ></td>
                                                <td>Device Type</td><td><input class="form-control" type="text" id="searchDeviceType" name="searchDeviceType" value="${searchDeviceTypeName}" size="20" ></td>
                                    ...
                                    <form name="form2" method="POST" action="DeviceRegistrationCont.do" onsubmit="return verify()">
                                          <table class="table table-hover" border="1" style="border-color:#d0dafd">
                                            ...
                                            <tr>
                                                ...
                                                <input class="form-control"  type="hidden" id="device_registration_id" name="device_registration_id" value="" ></td>
                                            </tr>

                                            <tr>
                                                <th class="heading1">Device Type</th>
                                                <td><input class="form-control"  type="text" id="device_type_name" name="device_type_name" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Model Name</th>
                                                <td><input class="form-control"  type="text" id="device_name" name="device_name" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="form-control"  type="text" id="registration_no" name="registration_no" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Manufacture Date</th>
                                                <td><input class="form-control"  type="text" id="manufacture_date" name="manufacture_date" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Sale Date</th>
                                                <td><input class="form-control"  type="text" id="sale_date" name="sale_date" value="" size="40" disabled></td>
                                            </tr>
