...
<script  type="text/javascript" src="time/bootstrap-datetimepicker.min.js"></script>
    ...
    <script type="text/javascript" language="javascript">
     ...
     $(function () {
            $("#searchManufacturerName").autocomplete({
                source: function (request, response) {
                    debugger
                    $.ajax({
                        url: "ManufacturerCont.do",
                        type: "GET",
                        dataType: "json",
                        data: {action1: "getManufacturerName"},
                ...
                select: function (events, ui) {
                    console.log(ui);
                    $('#searchManufacturerName').val(ui.item.label); // display the selected text
                    return false;
                }
            });
        });
...
<div class="container" style="margin-top: 5%">
    <table class="table table-hover"  style="background-color:#d0dafd ">
                ...
                <tr>
                    <td align="center" class="header_table" width="100%">Manufacturer</td>
                                    ...
                                    <form name="form0" method="POST" action="ManufacturerCont.do">
                                       <table class="table table-hover" border="1" style="border-color:#d0dafd">
                                            <tr>
                                                <td>Manufacturer Name</td><td><input class="form-control" type="text" id="searchManufacturerName" name="searchManufacturerName" value="${searchManufacturerName}" size="20" ></td>
                                                ...
                                                <td><input class="btn btn-danger" type="button" name="task" id="nextPage" value="Next Page" onclick="goToDevice()"></td>
                                                <td><input class="btn btn-info" class="pdf_button" id="viewPdf" name="viewPdf" value="Pdf" onclick="displayMapList()"></td>
                                       </tr>
                </table>
            </form></div>
                                    ...
                                    <form name="form2" method="POST" action="ManufacturerCont.do" onsubmit="return verify()">
                                         <table class="table table-hover" border="1" style="border-color:#d0dafd">
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="form-control" type="text" id="manufacturer" name="manufacturer" value="${manufacturer}" size="40" disabled>
                                                <input class="form-control" type="hidden" id="manufacturer_id" name="manufacturer_id" value="" ></td>
                                            </tr>  
                                            <tr>
