...
<script  type="text/javascript" src="time/bootstrap-datetimepicker.min.js"></script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(function () {
            $("#searchModelType").autocomplete({
                source: function (request, response) {
                    debugger
                    $.ajax({
                        url: "ModelTypeCont.do",
                        type: "GET",
                        dataType: "json",
                        data: {action1: "getDeviceType"},
                ...
                select: function (events, ui) {
                    console.log(ui);
                    $('#searchModelType').val(ui.item.label); // display the selected text
                    return false;
                }
            });
        });
    ...
    <table class="table table-hover"  style="background-color:#d0dafd ">
            ...
            <form name="form0" method="POST" action="ModelTypeCont.do">
                <table class="table table-hover" border="1" style="border-color:#d0dafd">
                    <tr>
                        <td>Model Type</td><td><input class="form-control" type="text" id="searchModelType" name="searchModelType" value="${searchModelType}" size="20" ></td>
                        ...
                        <td><input class="btn btn-danger" type="button" name="task" id="showAllRecords" value="Next Page" onclick="goToModel()"></td>
                        <td><input class="btn btn-info" type="button" class="pdf_button" id="viewPdf" name="viewPdf" value="Pdf" onclick="displayMapList()"></td>
                    </tr>
                </table>
            </form></div>
                ...
                <table class="table table-hover" border="1" style="border-color:#d0dafd">
                    ...
                    <tr>
                        ...
                        <td><input  class="form-control" type="text" id="model_type" name="model_type" value="" size="40" disabled>
                            <input  class="form-control" type="hidden" id="model_type_id" name="model_type_id" value="" ></td>
                    </tr>
                    <tr>
                        <th >Remark</th>
