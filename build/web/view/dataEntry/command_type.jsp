                                ...
                                <form name="form2" method="POST" action="CommandTypeCont.do" onsubmit="return verify()">
                                    <table class="table table-hover" border="1" style="border-color:#d0dafd">
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="form-control" type="text" id="model_type" name="model_type" value="" size="40" disabled></td>
                                                <input class="form-control" type="hidden" id="model_type_id" name="model_type_id" value="" >
                                        </tr>
                                        <tr>
                                            <th>Remark</th>
