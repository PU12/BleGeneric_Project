...
<div class="container" style="margin-top: 5%">
    <table class="table table-hover"  style="background-color:#d0dafd ">
                ...
                <tr>
                    <td align="center" class="header_table" width="100%">Characteristics</td>
                                    ...
                                    <form name="form0" method="POST" action="CharachtristicsCont.do">
                                        <table class="table table-hover" border="1" style="border-color:#d0dafd">
                                            <tr>
                                                <td>Characteristics Name</td><td><input class="form-control" type="text" id="searchCharachtersticName" name="searchCharachtersticName" value="${searchDeviceType}" size="20" ></td>
                                                ...
                                                <td><input class="btn btn-danger" class="pdf_button" id="viewPdf" name="viewPdf" value="Pdf" onclick="displayMapList()"></td>
                                            </tr>
                                        </table>
                                    </form></div>
                                    ...
                                    <form name="form2" method="POST" action="CharachtristicsCont.do" onsubmit="return verify()">
                                         <table class="table table-hover" border="1" style="border-color:#d0dafd">
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="form-control" type="text" id="charachtristics_name" name="charachtristics_name" value="" size="40" disabled>
                                                <input class="form-control" type="hidden" id="charachtristics_id" name="charachtristics_id" value="" >
                                            </tr>
                                            <tr>
                                                <th>Service Name</th>
                                            ...
                                            <tr>
                                                <th>UUID</th>
                                                <td><input class="form-control" type="text" id="uuid" name="uuid" value="" size="40" disabled></td>
                                            </tr>
