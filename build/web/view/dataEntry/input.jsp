                                    ...
                                    <form name="form2" method="POST" action="InputCont.do" onsubmit="return verify()">
                                       <table class="table table-hover" border="1" style="border-color:#d0dafd">
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="form-control"  type="text" id="command_name" name="command_name" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Parameter </th>
                                                <td><input class="form-control"  type="text" id="parameter" name="parameter" value="" size="40" disabled>
                                                <input class="form-control"  type="hidden" id="input_id" name="input_id" value="" ></td>
                                            </tr>
                                            <tr>
