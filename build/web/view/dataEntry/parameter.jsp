...
<!--                                                <td>Rule<input class="input" type="text" id="searchRule" name="searchRule" value="${searchRule}" size="20" ></td>-->
                                                <td>Parameter Name</td><td><input class="form-control" type="text" id="searchParameterName" name="searchParameterName" value="${searchParameterName}" size="20" ></td>
                                    ...
                                    <form name="form2" method="POST" action="ParameterCont.do" onsubmit="return verify()">
                                          <table class="table table-hover" border="1" style="border-color:#d0dafd">
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="form-control" type="text" id="parameter_name" name="parameter_name" value="" size="40" disabled>
                                                <input class="form-control" type="hidden" id="parameter_id" name="parameter_id" value="" ></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Parameter Type</th>
                                                <td><input class="form-control" type="text" id="parameter_type" name="parameter_type" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
